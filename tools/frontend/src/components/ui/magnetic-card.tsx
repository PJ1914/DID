...
export const MagneticCard = React.forwardRef<HTMLDivElement, MagneticCardProps>(
    ({ children, className, magneticStrength = 0.3, tiltStrength = 15, ...props }, ref) => {
        ...
        const rotateX = useTransform(mouseY, [-300, 300], [tiltStrength, -tiltStrength]);
        const rotateY = useTransform(mouseX, [-300, 300], [-tiltStrength, tiltStrength]);
